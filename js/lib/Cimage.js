...
Cimage.prototype.dom_build = function(p_src, force) {
    ...
    var img = $('<img/>');
    img.onload = function() {
	that.callback_onload();
    };
    img.onerror = function() {
	that.callback_onerror();
    };
    // console.log(opt);
...
Cimage.prototype.callback_onload = function() {
    ...
    if ('callback_onload' in this.options
	    && typeof (this.options.callback_onload) === 'function') {
...
Cimage.prototype.callback_onerror = function() {
    ...
    this.last_update = null;
    if ('callback_onerror' in this.options
	    && typeof (this.options.callback_onerror) === 'function') {
...
Cimage.prototype.callback_click = function() {
    ...
    if ('callback_click' in this.options
	    && typeof (this.options.callback_click) === 'function') {
