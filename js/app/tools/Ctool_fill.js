/**
 * Constructor / Ctool_fill
 */
function Ctool_fill(options) {
	options = options || {};
	options.className = 'Ctool_fill';
...
/* Inheritance */
Ctool_fill.prototype = Object.create(Ctool.prototype);
Ctool_fill.prototype.constructor = new Ctool();

/**
 * Method
 */
Ctool_fill.prototype.graph = function(cMessage) {
	...
	if (!slayer) { console.error('No layer selected'); return false;}
	var data = slayer.getImageData(0,0, slayer.get_width(), slayer.get_height());
