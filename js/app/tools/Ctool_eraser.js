/**
 * Constructor / Ctool_eraser
 */
function Ctool_eraser(options) {
	options = options || {};
	options.className = 'Ctool_eraser';
...
/* Inheritance */
Ctool_eraser.prototype = Object.create(Ctool.prototype);
Ctool_eraser.prototype.constructor = new Ctool();

/**
 * 
 * @param cMessage
 */
Ctool_eraser.prototype.pre_graph = function(cMessage) {
 ...
 * @param cMessage
 */
Ctool_eraser.prototype.post_graph = function(cMessage, x,y, width, height, dx, dy, dwidth, dheight) {//function(x,y,width,height,0,0,width,height) {
	//cMessage) {
 ...
 * Method
 */
Ctool_eraser.prototype.graph = function(cMessage) {
