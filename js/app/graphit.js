(function(window, graphit, console, undefined) {
	 ...
	 *              keybinding and act as a proxy threw our Csurface Its the
	 *              single entry point into the whole project, each created
	 *              object must be accessible threw it. #TODO: Using console to
	 *              create new object easily 06:00:32 / 23 nov. 2012 [jsgraph]
	 *              sho
	 */
		...
		var entry_login = {
			...
			callback_click : function() {
				...
				if (window.graphit.auth) {
					...
					url = window.graphit.baseStaticContent
							+ 'pages/no-authentication.htm';
				}
				try {
	...
	/**
	 * Return DOM corresponding to a given widget We are storing each widget
	 * into this.widgets
	 * 
	 * @param {cWidget}
	 *            An object having dom_get method
	 */
	Module.prototype.get_widget = function(cWidget) {
	 ...
	 */
	Module.prototype.dialog_new_surface = function() {
	 ...
	 * rootElm
	 */
	Module.prototype.surface_create = function(options) {
		var that = this;
		options.parent = this;
		var s = null;
		try {
		...
		this.bind_trigger(s.cSurface, 'surface_selected',
				function(e, cSurface) {
	 ...
	 */
	Module.prototype.dom_build_add_surface = function(cSurface_workspace) {
		var that = this;
		...
		cSurface.bind_trigger(cSurface, 'redraw_preview',
				function(e, eSurface) {
